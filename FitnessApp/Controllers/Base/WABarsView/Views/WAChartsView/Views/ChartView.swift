...
private extension ChartView {
    ...
    func drawChart(with data: [WAChartsView.Data], topChartOffset: Int) {
        guard let maxValue = data.sorted(by: {$0.value > $1.value} ).first?.value else { return } // максимальное значение из данных
        ...
        chartLayer.fillColor = UIColor.clear.cgColor // Что не зарисовывало все
